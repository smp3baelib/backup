...
function main_menu()
{
  ...
  $_menu  .= '<li><a class="menu visitor" href="'.SWB.'index.php?p=visitor" target="_blank"><i class="nav-icon '.$icon['visitor'].'"></i> <span class="s-menu-title">' . __('Visitor') . '</span></a></li>';
  $_menu  .= '<li><a class="menu facebook" href="https://www.facebook.com/groups/senayan.slims" target="_blank"><i class="nav-icon '.$icon['facebook'].'"></i> <span class="s-menu-title">' . __('Facebook SLiMS') . '</span></a></li>';
