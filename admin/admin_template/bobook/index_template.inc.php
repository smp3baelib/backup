...
<body>
<!-- main menu -->
<div id="mainMenu"><?php echo $main_menu; ?>
<a class="menu system" title="Ayo Konsultasi SLiMS Di Facebook" href="https://www.facebook.com/groups/senayan.slims" target="blank"><span><i class="fa fa-facebook"></i> Facebook</span></a>
</div>
<!-- main menu end -->
