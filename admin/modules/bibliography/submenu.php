...
//tambahan */
$menu[] = array(__('Label Barcodes'), MWB.'bibliography/label_barcode_generator.php', __('Cetak Label Barcode'));
//$menu[] = array(__('Label QRcode'), MWB.'bibliography/label_qrcode_generator_warna.php', __('Cetak Label QRcode Warna'));
$menu[] = array(__('Label Barcodes Warna'), MWB.'bibliography/label_barcode_generator_warna.php', __('Cetak Label Barcode Warna'));
$menu[] = array(__('Label Barcodes Warna v4'), MWB.'bibliography/label_barcode_generator_warna_v4.php', __('Cetak Label Barcode Warna v4'));
...
$menu[] = array(__('Cetak Kantong Buku'), MWB.'bibliography/book_pocket.php', __('Cetak Kantong Buku'));
...
$menu[] = array('Header', __('Shelving Pindah Rak'));
$menu[] = array(__('Shelving'), MWB.'bibliography/shelving.php', __('Shelving'));
