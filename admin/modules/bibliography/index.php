...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
  ...
  // Modified To SLiMS 8 By M.Zaemakhrus
  $str_input = '<div class="'.$visibility.'" ><a class="notAJAX button btn openPopUp",scrolling="no", href="'.MWB.'bibliography/pop_ddc.php?biblioID='.$rec_d['biblio_id'].'" title="'.__('e-DDC for SLiMS &copy 2016').'" height="500" width="850">'.__('e-DDC').'</a> Search Classification Number with Quick e-DDC</div>';
