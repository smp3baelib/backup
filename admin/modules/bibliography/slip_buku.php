...
<div class="menuBoxInner printIcon">
	<div class="per_title">
    <h2><?php echo __('Cetak Kartu Buku'); ?></h2>
  </div>
    ...
    <div class="btn-group">
      ...
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/slip_buku.php?action=print" class="notAJAX btn btn-success"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Cetak Slip Buku Dari Data Terpilih'); ?></a>
	</div>
