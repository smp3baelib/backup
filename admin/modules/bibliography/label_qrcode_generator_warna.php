...
include SWB.'lib/phpqrcode/qrlib.php';
...
if (isset($_POST['itemID']) AND !empty($_POST['itemID']) AND isset($_POST['itemAction'])) {
  ...
  foreach ($_POST['itemID'] as $itemID) {
    ...
    if (!empty($itemID)) {
      ...
      echo 'jQuery.ajax({ url: \''.SWB.'lib/phpqrcode/qrlib.php?code='.$itemID.'&encoding='.$sysconf['barcode_encoding'] "L" .'&mode=png\', type: \'GET\', error: function() { alert(\'Error creating barcode!\'); } });'."\n";
      //echo QRcode::png("http://www.niqoweb.com", "code.png", "L", 4, 4);
      // add to sessions
...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  $header_color = array(0=>"#FFE900",1=>"#d50000",2=>"#e65100",3=>"#ffff00",4=>"#05a818",5=>"#03a9f4",6=>" #9c27b0",7=>"#4e342e",8=>"#bdbdbd",9=>"#FFF");
...
<div class="menuBoxInner printIcon">
  ...
  <div class="sub_section">
	  <div class="btn-group">
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_qrcode_generator_warna.php?action=clear" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-trash"></i>&nbsp;<?php echo __('Clear Print Queue'); ?></a>
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_qrcode_generator_warna.php?action=print" class="notAJAX btn btn-success"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Print Barcodes for Selected Data');?></a>
    ...
    <form name="search" action="<?php echo MWB; ?>bibliography/label_qrcode_generator_warna.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
  ...
  if (isset($_SESSION['qrcodes'])) {
    echo '<font id="queueCount" style="color: #f00">'.count($_SESSION['qrcodes']).'</font>';
