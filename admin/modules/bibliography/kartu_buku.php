...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	$html_str .= '<head>'."\n";
	$html_str .= '<title>Kartu Buku by Muh Tarom Modifikasi Zaemakhrus</title>'."\n";
	...
	foreach ($chunked_book_card_arrays as $bookcard_rows) {
		...
		foreach ($bookcard_rows as $bookcard) {
			$html_str .= '<td valign="top">'."\n";
				...
				$html_str .= '<h3 style="margin: 0px 0px 4px 0px; padding: 3px;text-align: center; border: 1px solid #000; width: 100%;">Kartu Buku</h3>'."\n";
				...
				$html_str .= '<tr>'."\n";
				$html_str .= '<td valign="top" style="margin: 0;padding-top: 9px; text-align: center;height: 0.7cm; width: 4.4cm; font-size:16;">Tanggal Kembali</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0;padding-top: 9px; text-align: center;height: 0.7cm; width: 4.4cm;">Tanggal Kembali</td>'."\n";
				$html_str .= '</tr>'."\n";
				for($tr=1;$tr<=$rows;$tr++){
				$html_str .= '<tr>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center;height: 0.7cm; width: 4.4cm;">&nbsp;</td>'."\n";
				$html_str .= '<td valign="top" style="margin: 0; text-align: center;height: 0.7cm; width: 4.4cm;">&nbsp;</td>'."\n";
				$html_str .= '</tr>'."\n";}
				$html_str .= '</table>'."\n";
				$html_str .= '</div>'."\n";
...
<div class="menuBoxInner printIcon">
    ...
    <div class="btn-group">
      ...
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/kartu_buku.php?action=print" class="notAJAX btn btn-success"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Cetak Kartu Buku'); ?></a>
	</div>
...
if ($sysconf['index']['type'] == 'index' || ($sysconf['index']['type'] == 'sphinx' && file_exists(LIB.'sphinx/sphinxapi.php'))) {
	...
	$datagrid->setSQLColumn('item.item_code',
		...
		'item.call_number AS \''.__('Nomor Panggil').'\'',
