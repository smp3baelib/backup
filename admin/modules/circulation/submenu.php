...
$menu[] = array('Header', __('Baca Di Tempat'));
$menu[] = array(__('Baca Di Tempat'), MWB.'circulation/read_counter.php', __('Baca Di Tempat'));
$menu[] = array(__('Buku Dibaca Di Tempat'), MWB.'circulation/read_counter.php?action=detail', __('Buku Dibaca Di Tempat'));
$menu[] = array(__('Laporan Baca Di Tempat'), MWB.'circulation/counter_report_day.php', __('Laporan Baca Di Tempat'));
