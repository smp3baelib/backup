...
if (isset($_POST['quickReturnID']) AND $_POST['quickReturnID']) {
    ...
    if ($loan_info_q->num_rows < 1) {
        ...
        $table->setCellAttr(1, 0, 'class="dataListHeader" style="color: #fff; font-weight: bold; background:#351901;" colspan="4"');
        ...
        //add heru 2014 , custom Zaemakhrus 2016 to Akasia 8.4
        $table->appendTableRow(array('Sisa Pinjaman Saat, Peringatkan Member Untuk mengembalikan ini'));
        $table->appendTableRow(array(__('Item Code'),__('Title'),__('Loan Date'),__('Due Date')));
        $table->setCellAttr(5, 0, 'class="dataListHeader" style="color: #fff; font-weight: bold; background:#C11300;" colspan="5"');
