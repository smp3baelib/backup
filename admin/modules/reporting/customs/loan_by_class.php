...
<?php
    ...
    echo '<a class="printReport" onclick="window.open(\''.MWB.'reporting/plot_report.php?chart=loan_by_class&coll_type='.$coll_type.'&class='.$class_num.'&year='.$selected_year.'\', \'myWindow\', \'status=0, width=950, height=600, noborder=0\')">'.__('Show in chart/plot').'</a></div>';
    echo $output;
