...
<?php
    ...
    */
    ...
    $output .= '<tr>';
    $output .= '<td class="dataListHeaderPrinted" style="color: #255F24; font-weight: bold;">'.__('Total visit/month').'</td>';
    foreach ($months as $month_num => $month) {
    ...
    // print out
    echo '<div class="printPageInfo">Total Pengunjung Perpustakaan Tahun <strong>'.$selected_year.'</strong> <a class="printReport" onclick="window.print()" href="#">'.__('Print Current Page').'</a></div>'."\n";
