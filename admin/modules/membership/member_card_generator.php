...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	*/
    ...
    $html_str .= '#photo_blank_div{z-index:5;position: absolute;left: 10px;top:125px;font-size: 7px;text-align: center;}'."\n";
    $html_str .= '#photo_div{z-index:6;position: absolute;left: 10px;top:125px;width:'.($sysconf['print']['membercard']['photo_width']*$sysconf['print']['membercard']['factor']).'px; height:'.($sysconf['print']['membercard']['photo_height']*$sysconf['print']['membercard']['factor']).'px;}'."\n";
    ...
    $html_str .= '.exp_div{z-index:18;position: absolute;left: 120px;top: 142px;width:150px;height: 12px;font-size: 8px;text-align: right;}'."\n";
    $html_str .= '.barcode_div{z-index:19;position: absolute;left: 150px;top: 154px;width:150px;height: 42px;}'."\n";
    $html_str .= '</style>'."\n";
    $html_str .= '</head>'."\n";
    $html_str .= '<body>'."\n";
    ...
    foreach ($chunked_card_arrays as $membercard_rows) {
        ...
        foreach ($membercard_rows as $card) {
          ...
          $html_str .= '</div>';
          $html_str .= '<div id="photo_blank_div"><img width="'.($sysconf['print']['membercard']['photo_width']*$sysconf['print']['membercard']['factor']).'px" height="'.($sysconf['print']['membercard']['photo_height']*$sysconf['print']['membercard']['factor']).'px" src="'.SWB.IMG.'/persons/person.png" /></div>';
...
$datagrid->column_width = array('10%', '60%','10%', '15%');
