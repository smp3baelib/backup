...
// IP based access limitation member_card_generator_2.php
do_checkIP('smc');
...
$menu[] = array(__('Kartu D1'), MWB.'membership/member_card_generator_1.php', __('Kartu Anggota Desain 1'));
$menu[] = array(__('Kartu D2'), MWB.'membership/member_card_generator_2.php', __('Kartu Anggota Desain 2'));
$menu[] = array(__('Kartu D3'), MWB.'membership/member_card_generator_3.php', __('Kartu Anggota Desain 3'));
$menu[] = array(__('Member Card Printing'), MWB.'membership/member_card_generator.php', __('Print Member Card'));
$menu[] = array('Header', __('Data CSV'));
