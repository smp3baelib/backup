...
$str_input  = simbio_form_element::selectList('hourTask', $hour_options,$_hour, 'style="width: 80px;"');

for($min=0;$min<=59;$min++){ $minutes_options[] = array($min,$min);}
$str_input .= simbio_form_element::selectList('minutesTask', $minutes_options, $_minutes, 'style="width: 80px;"');
