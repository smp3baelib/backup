...
if (isset($_POST['counter'])) {
  ...
  */
  ...
  // Audio Trima Kasih Oleh Dimodifikasi Untuk SLiMS 8.4.x oleh M.Zaemakhrus
  $audio = "<element hidden><audio controls autoplay><source src='files/sound/voice2.mp3' type='audio/mpeg'><source src='files/sound/voice2.ogg' type='audio/ogg'></audio></element>";
  $audio1 = "<element hidden><audio controls autoplay><source src='files/sound/voice3.mp3' type='audio/mpeg'><source src='files/sound/voice3.ogg' type='audio/ogg'></audio></element>";
  //
